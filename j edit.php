<?php
 ...
 $id = $_GET['id'];
 $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from jewellery where id='$id'"));
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row" style="height:410px;">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5" style="margin-top:-35px;"> 
                                    ...
                                    <h1 class="h4 text-gray-900 mb-1">New Jewellery</h1>
                                    </div>
                                    <form class="user"action="j update.php" method ="post" enctype = "multipart/form-data">
