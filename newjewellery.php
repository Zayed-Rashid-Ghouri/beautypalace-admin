...
<nav style="width:100%; height:50px; background-color:rgb(250, 234, 210) ;">
        ...
        <a href="jewellery.php"  style="color:white; text-decoration: none; "><p style="font-size: 40px; margin-left: 39%;color:rgb(102, 62, 16); " ><i class="fas fa-gem" style="font-size: 45px; margin-top: 1.3%;"></i>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row" style="height:370px;">
                            <div class="col-lg-6 d-none d-lg-block"> <img src="images/jewelry.jpg" style="width:500px; height:370px; " alt=""></div>
                            <div class="col-lg-6">
                                <div class="p-5" style="margin-top:-35px;"> 
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">New Jewellery</h1>
                                    </div>
...
$query = "insert into jewellery values (null,'$name','$description' ,'$price','$imagename')";
